...
producer=KafkaProducer(bootstrap_servers=['128.110.154.221:9092','128.110.154.213:9092','128.110.154.204:9092'],linger_ms=10,value_serializer=lambda v: json.dumps(v).encode('utf-8'))
            ...
            if json_response_list==[]:
                ...
                for json_response in json_response_list:
                    ...
                    if matching_rule=='covid123':
                        ...
                        producer.send('covid-tweets-cluster',json_response)
                        producer.flush()
                    if matching_rule=='vaccine':
                        ...
                        producer.send('vaccine-tweets-cluster',json_response)
                        producer.flush()
